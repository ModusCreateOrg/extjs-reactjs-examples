...
This project contains a simple `MyComponent` class in `src/MyComponent.js` defined using functional syntax (versus extending `React.Component`). `MyComponent` is then instantiated by the `App` component exported from `my-app/src/App.js`.
