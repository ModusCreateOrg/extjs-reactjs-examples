...
This project creates a login form whose input fields' values are saved on the parent component's state.  The state's values are then referenced and sent to a remote server when the form is submitted similar to Ext JS Form's `getValues` method.
