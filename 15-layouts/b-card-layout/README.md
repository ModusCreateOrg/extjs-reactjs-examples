...
In this example, two child components are composed within the parent container. The active / visible / rendered component is determined by the index number passed in the `activeCard` prop of the `App` component.  It defaults to 0.
