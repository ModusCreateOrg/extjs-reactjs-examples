...
This project creates a company roster using `src/Company.js` whose content is furnished by a data object in `src/App.js`.  The JSX returned in the `Company` instance is similar to the HTML templating you may be familiar with coming from Ext JS.
