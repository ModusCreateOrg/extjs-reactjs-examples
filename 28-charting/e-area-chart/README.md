...
This project creates an area chart using the React charting library: [Recharts](https://www.npmjs.com/package/recharts).
...
[![Edit e-area-chart](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/ModusCreateOrg/extjs-reactjs-examples/tree/master/28-charting/e-area-chart)
