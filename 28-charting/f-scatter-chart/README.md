...
This project creates a scatter chart using the React charting library: [Recharts](https://www.npmjs.com/package/recharts).
...
[![Edit f-scatter-chart](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/ModusCreateOrg/extjs-reactjs-examples/tree/master/28-charting/f-scatter-chart)
