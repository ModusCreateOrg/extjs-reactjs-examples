...
This project creates a list from an array of data objects.  `src/App.js` iterates over the items in the array and returns `ListItem` components from `src/ListItem.js`.  `ListItem` imports `src/ListItem.css` to decorate the list rows.
