...
This project creates a basic grid with a header and rows of data.  The simple grid component is fed an array of data which the component loops over to populate each grid row.
